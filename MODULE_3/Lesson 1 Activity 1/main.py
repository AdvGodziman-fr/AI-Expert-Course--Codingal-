# Hand Landmark Detection using Python (3.10.11)
import mediapipe as mp
import cv2

# Get the hands solution from MediaPipe
mp_hands = mp.solutions.hands

# Create a Hands object with our settings
...
while True:
    ...
    status_color = (0, 255, 0) if gesture in [
        "Open", "Closed Fist"] else (0, 165, 255)
